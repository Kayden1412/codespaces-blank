...
<div>
    <a href="/anime/{id}" class="relative text-sm">
        <enhanched:img decoding="async" src={coverImg.webp.image_url} alt="{title} Cover" class="object-cover w-full h-full transition duration-300 opacity-100">
